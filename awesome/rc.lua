...
awful.spawn.with_shell(
	'if (xrdb -query | grep -q "^awesome\\.started:\\s*true$"); then exit; fi;'
		...
		.. "feh --bg-scale ~/Downloads/gruv-sushi-streets.jpg;"
		.. "polybar;"
		.. 'xautolock -time 10 -locker "i3lock -c 282828";'
...
globalkeys = gears.table.join(
	...
	awful.key({}, "Print", function()
		awful.util.spawn("maim --select /home/$USER/Pictures/$(date).png", false)
	end),
	awful.key({ modkey }, "Print", function()
		awful.util.spawn("maim /home/$USER/Pictures/$(date).png", false)
	end),
	--lock
	awful.key({ modkey }, "y", function()
		awful.util.spawn("i3lock -c 282828", false)
	end),
	--brightness
	...
	awful.key({ modkey }, "d", function()
		awful.spawn(menu)
	end, { description = "open memu", group = "launcher" }),
...
clientkeys = gears.table.join(
	awful.key({ modkey }, "f", function(c)
		...
		c:raise()
	end, { description = "kill a client", group = "client" }),
